...
<?php if (get_field('content_section')) { ?>
    <div class="section-desktop fp-scrollable" itemscope itemtype="http://schema.org/ImageGallery">
        <?php while (has_sub_field('content_section')) { ?>
            ...
            <?php if (get_row_layout() === '2_column_text') { ?>
                <?php if (get_field('split_up_on_mobile')) { ?><div class="section-mobile fp-scrollable"><?php } ?>
                    <div class="content-container text-container-accordion">
                        <?php
                        $accordion_class = '';
                        $accordion_id = '';
                        ...
                        <?php } ?>
                        <div id="<?= $accordion_id; ?>" class="two-column-text-container <?= $accordion_id; ?> <?= $accordion_class; ?> <?php if (get_sub_field('full_width')) { ?>full-width<?php } ?>">
                            <div class="row">
                                <div class="col-12 col-md-10">
                ...
                <?php if (get_field('split_up_on_mobile')) { ?></div><?php } ?>
            <?php } ?>
    ...
    <?php if (!get_field('split_up_on_mobile')) { ?><div class="section-mobile fp-scrollable"><?php } ?>
        ...
        <?php if (get_field('one_image_randomly_on_mobile')) { shuffle($all_content_sections); } ?>
        ...
        <?php foreach ($all_content_sections as $content_section) { ?>
            <?php if ($content_section['acf_fc_layout'] === 'image' && $content_section['image']) { ?>
                <?php if (!get_field('split_up_on_mobile')) { ?><div class="image-section-mobile-wrapper"><?php } ?>
